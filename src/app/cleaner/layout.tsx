          ...
          <div className="flex items-center gap-4">
            ...
            {session?.user && (
              <nav className="flex gap-4 text-sm">
                <Link href="/cleaner/bookings"     className="text-gray-600 hover:text-gray-900 transition-colors">My Bookings</Link>
                <Link href="/cleaner/availability" className="text-gray-600 hover:text-gray-900 transition-colors">Availability</Link>
              </nav>
            )}
          </div>
